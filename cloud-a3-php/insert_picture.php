...
<body>
<a href="#" id="upload_widget_opener" name="uploadwidget">Upload</a><br><br>
...
function loadDoc() {
	...
	var url = "https://cloud-a3-shipra1.azurewebsites.net/insertpic";
...
<body>
<p>Upload image and Refresh the Page. Then enter Student Id and click Insert</p>

<h1><a href="index.php">Home</a></h1>
<p> <b id='message'></b> </p> 
Student ID:<br>
  <input type="text" name="id" id="id" value="" required><br>
  <button type="button" onclick="loadDoc()">Insert Picture</button>
